...
class WhisperModelModule(LightningModule):
    def __init__(self,
        ...
        self.train_dataset = WhisperASRDataset(self.train_manifest, self.train_root, self.tokenizer, sum_limit_duration=9999*3600)
        self.val_dataset = WhisperASRDataset(self.val_manifest, self.val_root, self.tokenizer)
