...
if __name__=="__main__":
    with open("D:\\srqu_report-materials\\ref1.csv", encoding="utf8", newline='') as f_csv:
        reader = csv.reader(f_csv, delimiter='\t')
        for row in reader:
            groundtruth[row[0]] = row[1]

    with open("D:\\srqu_report-materials\\hypo_no_dict_small.csv", encoding="utf8", newline='') as f_csv:
        reader = csv.reader(f_csv, delimiter='\t')
        for row in reader:
    ...
    with open("recipes/srqu/srqu_boost_dictionary_algor_small.csv", encoding="utf8", mode='w', newline='') as f_csv:
