...
parser.add_argument(
    "--input_path", help="", type=str, default="/home/barb_cinnamon_is/libri/output.txt"
)
parser.add_argument(
    "--whispered_path",
    help="",
    type=str,
    default="/home/barb_cinnamon_is/libri/output_whispered.txt",
)
parser.add_argument(
    "--arpa_output_path",
    help="",
    type=str,
    default="/home/barb_cinnamon_is/libri/kenlm.arpa",
)
parser.add_argument(
    "--model_output_path",
    help="",
    type=str,
    default="/home/barb_cinnamon_is/libri/libri.bin",
)
