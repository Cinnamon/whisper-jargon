...
parser.add_argument("--input_path", help="",
                    type=str, default="/home/barb_cinnamon_is/HCP-600-IPhone6L-parsed/output.txt")
parser.add_argument("--whispered_path", help="",
                    type=str, default="/home/barb_cinnamon_is/HCP-600-IPhone6L-parsed/output_whispered.txt")
parser.add_argument("--arpa_output_path", help="",
                    type=str, default="/home/barb_cinnamon_is/HCP-600-IPhone6L-parsed/kenlm.arpa")
parser.add_argument("--model_output_path", help="",
                    type=str, default="/home/barb_cinnamon_is/HCP-600-IPhone6L-parsed/hgp-600.bin")
